 ...
 **************************************************
 *
 * @file        Example28_GetLeapSecondInfo.ino
 *
 * @brief       Getting leap second event info as SNTP Leap Indicator, time to a leap second event and the number of leap seconds since GPS epoch
 * By: UT2UH
