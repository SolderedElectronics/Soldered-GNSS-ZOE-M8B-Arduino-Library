/**
 **************************************************
 * @file        Example16_NTRIPClient_WithGGA.ino
 *
 * @brief        Use ESP32 WiFi to get RTCM data from RTK2Go (caster) as a Client, and transmit GGA (needed for some
 *Casters) By: SparkFun Electronics / Nathan Seidle Date: November 18th, 2021 License: MIT. See license file for more
 *information but you can basically do whatever you want with this code.
 *
 ...
 *
 *               You will need to have a valid mountpoint available. To see available mountpoints go here:
...
void beginClient()
{
    ...
    while (Serial.available() == 0)
    {
        ...
        if (ntripClient.connected() == true && transmitLocation == true &&
            (millis() - lastTransmittedGGA_ms) > timeBetweenGGAUpdate_ms && ggaSentenceComplete == true &&
