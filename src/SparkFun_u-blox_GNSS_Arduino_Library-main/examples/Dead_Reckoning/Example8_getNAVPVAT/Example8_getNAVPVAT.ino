...
void loop()
{
    ...
    {
        Serial.print(F("Roll: "));
        Serial.print((float)myGNSS.getVehicleRoll() / 100000.0,
                     5); // Use the helper function to get the roll in degrees * 10^-5

        Serial.print(F(" Pitch: "));
        Serial.print((float)myGNSS.getVehiclePitch() / 100000.0,
                     5); // Use the helper function to get the pitch in degrees * 10^-5

        Serial.print(F(" Heading: "));
        Serial.print((float)myGNSS.getVehicleHeading() / 100000.0,
                     5); // Use the helper function to get the heading in degrees * 10^-5

        // We don't have helper functions to extract the roll, pitch and heading valid flags from the PVAT message. But
        ...
        // We don't have helper functions to extract the roll, pitch and heading accuracy from the PVAT message. But we
        // can do it manually:
