...
void setup()
{
    ...
    if (myGNSS.setAutoHNRATTcallback(&printHNRATTdata) ==
        true) // Enable automatic HNR ATT messages with callback to printHNRATTdata
        Serial.println(F("setAutoHNRATTcallback successful"));

    if (myGNSS.setAutoHNRINScallback(&printHNRINSdata) ==
        true) // Enable automatic HNR INS messages with callback to printHNRINSdata
        Serial.println(F("setAutoHNRINScallback successful"));

    if (myGNSS.setAutoHNRPVTcallback(&printHNRPVTdata) ==
        true) // Enable automatic HNR PVT messages with callback to printHNRPVTdata
