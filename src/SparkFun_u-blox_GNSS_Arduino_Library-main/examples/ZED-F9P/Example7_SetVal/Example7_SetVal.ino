...
void setup()
{
    ...
    // but with setVal().
    // Original: myGNSS.enableRTCMmessage(UBX_RTCM_1005, COM_PORT_I2C, 1); //Enable message 1005 to output through I2C
    // port, message every second setValueSuccess = myGNSS.setVal(UBLOX_CFG_MSGOUT_RTCM_3X_TYPE1005_I2C, 1); //Set output
    // rate of msg 1005 over the I2C port to once per second
