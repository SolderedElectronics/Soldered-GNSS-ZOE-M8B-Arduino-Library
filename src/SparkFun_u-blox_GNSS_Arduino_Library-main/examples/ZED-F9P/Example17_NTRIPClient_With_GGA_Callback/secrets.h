...
const char casterUser[] =
    "NTRIPusername+accountSubdomain"; // This is generated when you add a device to your Skylark account
const char casterUserPW[] = "devicePassword";
const char mountPoint[] =
    "CRS"; // The mount point you want to get data from. Select CRS (Cloud Reference Station) for the ZED-F9x
