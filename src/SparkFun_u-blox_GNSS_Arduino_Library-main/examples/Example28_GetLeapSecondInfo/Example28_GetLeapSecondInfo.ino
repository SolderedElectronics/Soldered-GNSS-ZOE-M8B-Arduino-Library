/*
  Getting leap second event info as SNTP Leap Indicator, time to a leap second event and the number of leap seconds
  since GPS epoch By: UT2UH Date: April 14th, 2021 License: MIT. See license file for more information but you can
  basically do whatever you want with this code.

  This example shows how to query a u-blox module for the leap second event info to cast to SNTP Leap Indicator
  enumeration. We also turn off the NMEA output on the I2C port. This decreases the amount of I2C traffic dramatically.
